...
namespace FYPMSWebsite.App_Code
{
    ...
    public class FYPMSDB
    {
            ...
            string progressGrade, string finalGrade, string presentationGrade)
        {
            ...
            //***************************************************************************************
            sql = "update Requirement set progressGrade="+progressGrade+",presentationGrade="+presentationGrade+" where studentUsername='" + studentUsername + "' and "+fypId+" in (select F.fypId from FYProject F,Supervises S,Requirement R where s.fypid = f.fypid and r.facultyusername = s.username and r.studentusername = '"+studentUsername+"')";
            return SetData(sql);
        }
